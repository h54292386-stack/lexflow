...
export default function LawyerDetails() {
  ...
  <div className="bg-[#F5F5F5] min-h-screen py-10 px-6">
    <div className="max-w-6xl mx-auto space-y-6">
       <button          onClick={() => navigate("/lawyers")} className="absolute top-6 left-8 text-xs text-gray-400 hover:underline">
          <FaArrowLeft />
        </button>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 flex flex-col md:flex-row gap-8 items-center md:items-start relative">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          {/* Button */}
          <button className="mt-6 flex items-center gap-2 border border-black px-5 py-2 rounded-lg hover:bg-black hover:text-white transition mx-auto md:mx-0">
            <FiMessageSquare />
            Send Message
          </button>
        </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-5 text-sm text-gray-700">
                ...
                <div className="flex gap-3 items-center">
                  <FaAddressCard />
                  <span>
                    {lawyer.barCouncilNumber || "Bar Council ID not available"}
                  </span>
                </div>
